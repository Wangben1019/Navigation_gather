...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/wang/2dnav_ws/src/navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/wang/2dnav_ws/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/wang/2dnav_ws/install)
...
if(NOT "/home/wang/2dnav_ws/src/navigation/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/wang/2dnav_ws/src/navigation/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wang/2dnav_ws/src/navigation/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
