...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/uaspc01/Navigation_gather/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/uaspc01/Navigation_gather/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/uaspc01/Navigation_gather/install)
...
if(NOT "/home/uaspc01/Navigation_gather/devel/include;/home/uaspc01/Navigation_gather/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/uaspc01/Navigation_gather/devel/include;/home/uaspc01/Navigation_gather/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uaspc01/Navigation_gather/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
