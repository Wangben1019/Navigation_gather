...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/wang/2dnav_ws/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/wang/2dnav_ws/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/wang/2dnav_ws/install)
...
if(NOT "/home/wang/2dnav_ws/devel/include;/home/wang/2dnav_ws/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/wang/2dnav_ws/devel/include;/home/wang/2dnav_ws/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wang/2dnav_ws/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
