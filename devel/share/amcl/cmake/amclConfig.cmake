...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/wang/2dnav_ws/src/navigation/amcl)
  set(amcl_DEVEL_PREFIX /home/wang/2dnav_ws/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/wang/2dnav_ws/install)
...
if(NOT "/home/wang/2dnav_ws/devel/include;/home/wang/2dnav_ws/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/wang/2dnav_ws/devel/include;/home/wang/2dnav_ws/src/navigation/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wang/2dnav_ws/src/navigation/amcl/${idir}'.  ${_report}")
    endif()
