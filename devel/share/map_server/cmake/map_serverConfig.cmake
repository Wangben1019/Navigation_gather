...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/uaspc01/Navigation_gather/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /home/uaspc01/Navigation_gather/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/uaspc01/Navigation_gather/install)
...
if(NOT "/home/uaspc01/Navigation_gather/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/uaspc01/Navigation_gather/src/navigation/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uaspc01/Navigation_gather/src/navigation/map_server/${idir}'.  ${_report}")
    endif()
